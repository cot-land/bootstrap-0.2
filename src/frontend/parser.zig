    ...
    fn parseOperand(self: *Parser) ParseError!?NodeIndex {
        ...
        switch (self.tok.tok) {
            ...
            .at => {
                ...
                } else if (std.mem.eql(u8, builtin_name, "intCast") or std.mem.eql(u8, builtin_name, "ptrCast") or std.mem.eql(u8, builtin_name, "intToPtr")) {
                    // @intCast(Type, value), @ptrCast(Type, value), or @intToPtr(Type, value) - type argument and expression argument
